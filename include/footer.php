  ...
  <script>
      ...
      function addtocart(product_id, product_name, product_image, product_price, url, product_baseprice) {
          console.log("My id is " + product_id);
          var product_quantity = jQuery('#qty').val();
          ...
          if (product_quantity > 0) {
              jQuery.ajax({
                  ...
                  success: function(result) {
                      alert(result);
                      console.log("New Cart is " + result);
                      window.location.reload();
                  }
              });
          } else {
      ...
      function remove_item_from_cart(product_id, product_name) {
          console.log("Delete Cart is " + product_id);
          jQuery.ajax({
              url: "ajax.php",
              method: "POST",
              data: {
  ...
  <script>
              ...
              success: function(html) {
                  ...
                  if (data2.length > 0) {
                      for (let i = 0; i < data2.length; i++) {
                          ...
                          htmldiv += `  
                        <a href="product.php?url=${element.url}" >
                                        <li style="text-align: left;
    padding: 5px 15px;
    border: 1px solid #e4dede;    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
    overflow: hidden;">${element.name}</li>
                                    </a>  
                             `;
                      }
                  } else {
                      htmldiv += ` <a href="" >
                                        <li style="text-align: left;
    padding: 5px 15px;
    border: 1px solid #e4dede;">No Result Found</li>
                                    </a>  `
                  }

                  // document.getElementById('search_data').innerHTML = htmldiv;
                  var searchList = document.getElementById('search_data');
      ...
      function search2(str) {
          ...
          console.log("Search query: " + str);
          if (str.trim() === '') {
              document.getElementById('search_data1').style.display = 'none';
              return; // Exit the function
          }
    ...
    border: 1px solid #e4dede;">No Result Found</li>
                  ...
                  // document.getElementById('search_data').innerHTML = htmldiv;
                  var searchList = document.getElementById('search_data1');
                  searchList.innerHTML = htmldiv;
                  if (data2.length > 0) {
                      searchList.style.display = 'block';
                  }
