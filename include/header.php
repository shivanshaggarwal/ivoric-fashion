<!-- Back To Top -->
              ...
              <div class="col-lg-12 d-flex justify-content-between align-items-center">
                  ...
                  <div class="nav-right">
                      <ul>
                          ...
                          <div class="d-flex align-items-center">
                              <li class="px-2">
                                  <!-- auth-aware user button (handled in footer JS) -->
                                  <a href="#" id="topbar-user-btn" class="user" data-logged="<?php echo isset($_SESSION['u_id']) ? '1' : '0'; ?>">
  ...
  <div class="mobile-bottom-wrapper">
      <ul>
          ...
          <li>
              <a href="#" id="mobile-topbar-user-btn" data-logged="<?php echo isset($_SESSION['u_id']) ? '1' : '0'; ?>">
                  <div class="icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path
